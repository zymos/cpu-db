...
<div style="border-style: solid; border-width: 1px;width:800px;padding:10px;">
	<div style="font-weight: bold; font-size:20px;">Notes on how to edit:</div><br />
		...
		<ul>
			...
			<li>V, W: <i>Volts, Watts, degrees Celsius</i> </li>
			<li>C: <i>Celsius</i> </li>
...
function display_upload_page(){ // page=about
	...
	<ul>
		...
		<li>Must be less than 1 MiB</li>
		<li>Must have a height or width greater or equal to 1000px</li>
	</ul>

	<form action="upload_image.php" method="post" enctype="multipart/form-data">
	Filename: <input type="file" name="file" id="file"><br />
	Desired filename:  <input type="file" name="file" id="file"><br />
	Manufacture: <input type="text" name="manuf"><br />
	Part number: <input type="text" name="part"><br />
	Chip's photo of top, bottom, or die? <select name="side">
	...
	License: <select name="license">
		<option disabled="disabled" style="color: GrayText" value="">Your own work:</option>
			<option disabled="disabled" style="color: GrayText" value="">  Allow non-commercial use, commercial use, and modifications as long as others credit you and share alike:</option>
			<option title="{{self|cc-by-sa-3.0|GFDL|migration=redundant}}" value="self|cc-by-sa-3.0|GFDL|migration=redundant">    Own work, multi-license with CC-BY-SA-3.0 and GFDL</option>
			<option title="{{self|cc-by-sa-3.0,2.5,2.0,1.0}}" value="self|cc-by-sa-3.0,2.5,2.0,1.0">    Own work, multi-license with CC-BY-SA-3.0 and older</option>
			<option title="{{self|cc-by-sa-3.0}}" value="self|cc-by-sa-3.0">    Own work, Creative Commons Attribution-Share Alike 3.0</option>
		<option disabled="disabled" style="color: GrayText" value="">  Allow non-commercial use, commercial use, and modifications as long as others credit you:</option>
			<option title="{{self|cc-by-3.0}}" value="self|cc-by-3.0">    Own work, Creative Commons Attribution 3.0</option>
		<option disabled="disabled" style="color: GrayText" value="">  Reserve no rights:</option>
		...
		<option disabled="disabled" style="color: GrayText" value="">Freely licensed:</option>
			<option title="{{cc-by-sa-3.0}}" value="cc-by-sa-3.0">  Creative Commons Attribution-Share Alike 3.0</option>
			<option title="{{cc-by-3.0}}" value="cc-by-3.0">  Creative Commons Attribution 3.0</option>
			<option disabled="disabled" style="color: GrayText" value="">Public domain:</option>
		</select>
		<input type="text" name="submission_comments"><br /><br />
	<label for="file">Manufacture:</label>
		<input type="text" name="submission_comments"><br /><br />
	<input type="hidden" name="add_or_edit" value="$add_or_edit">
