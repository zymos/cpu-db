...
function display_upload_page(){ // page=about
	...
	<ul>
		...
		<li>Date format: [4 digit YEAR]-[2 digit MONTH]-[2 digit DAY]. e.g. 2013-01-28 </li>
	</ul>
	</div><br />
...
<br />
	...
	Date created:<sup style="color: red; font-style: italic;">*</sup> <input type="text" name="date"><i>format: YYYY-MM-DD</i><br /><br /> 
